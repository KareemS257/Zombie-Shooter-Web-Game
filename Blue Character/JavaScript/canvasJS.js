...
function sound(src) {
    var sou
    sou = document.createElement("audio");
    sou.src = src;
    sou.setAttribute("preload", "auto");
    sou.setAttribute("controls", "none");
...
////////////////////////////////////////////////////////////////////
var p1 = new Player(1920 / 2, 1080 / 2, 100, 50);
